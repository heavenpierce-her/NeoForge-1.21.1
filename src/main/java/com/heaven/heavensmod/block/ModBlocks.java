package com.heaven.heavensmod.block;
...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS =
            DeferredRegister.createBlocks(HeavensMod.MOD_ID);

    public static final DeferredBlock<Block> JOB_BLOCK = registerBlock("jobapp_block",
